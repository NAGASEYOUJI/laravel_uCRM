...
<template>
 <div v-show="isShow" class="modal" id="modal-1" aria-hidden="true">
  ...
  <input name="costomer" v-model="search" class="w-full bg-gray-100 bg-opacity-50 rouded boder border-gray-300 focus:border-indigo-500 focus: bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
  <button @click="searchCustmers" type="button" data-micromodal-trigger="modal-1" class="flex mx-auto text-white bg-teal-500 border-0 py px-8 focus:ouyline-none hover:bg-teal-600 rounded text-lg">検索する</button>   
</template> 